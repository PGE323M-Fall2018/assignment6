...
class TestSolution(unittest.TestCase):
    def test_least_squares(self):
        ...
        np.testing.assert_allclose(
            kc.least_squares(A, b), np.array([1.82857143, 1.98571429]), atol=0.001
        )
    ...
    def test_fit(self):
        ...
        np.testing.assert_allclose(
            kc.fit(), np.array([1.05933127e01, 2.35173520e04]), atol=0.001
        )
    ...
    def test_fit_through_zero(self):
        ...
        np.testing.assert_allclose(
            kc.fit_through_zero(), 26133.929742741482, atol=0.001
        )
